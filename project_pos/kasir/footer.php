  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $("body").on("click", "#tombol-tambahkan", function() {
        ...
        if ($("#tambahkan_jumlah").val()) {
          jumlah = $("#tambahkan_jumlah").val();
          jumlahTrue = true;
        } else {
          jumlah = $("#tambahkan_jumlah_grosir").val();
          jumlahTrue = false;
        }
        ...
        } else if (jumlah == 0 && jumlahTrue == true) {
          alert("Jumlah harus lebih besar dari 0");
        } else if (jumlah < 10 && jumlahTrue == false) {
          alert("Minimal jumlah harus 10");
        } else {
