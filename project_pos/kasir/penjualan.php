                    ...
                    <tr>
                      ...
                      <td class="text-center">    
                        ...
                        <div class="btn-group">
                          ...
                          <a target="_blank" href="penjualan_print.php?preorder&id=<?php echo $d['invoice_id']; ?>" class="btn btn-success btn-sm"><i class="fa fa-file"></i></a>
                          
                          <a href="penjualan_edit.php?preorder&id=<?php echo $d['invoice_id']; ?>" class="btn btn-warning btn-sm"><i class="fa fa-cog"></i></a>
