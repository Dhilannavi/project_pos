                  ...
                  ?>
                    <div class="col-lg-3">
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="Masukkan No Tel Pelanggan .. (Wajib)" value="<?php echo $i['no_telp'] ?>" required>
                      </div>
                    </div>
                  <?php } ?>
                        ...
                        <table class="table table-bordered table-striped">
                          ...
                          <tr>
                            ...
                            <td>
                              <div class="row">
                                <div class="col-lg-10">
                                  <input class="form-control phone_number" type="tel" id="nomor_telepon" name="nomor_telepon" placeholder="Masukkan Nomor Telepon" required="required">
                                </div>
                              </div>
                            </td>
                          </tr>
