      ...
      <section class="col-lg-12">
        <div class="box box-info">
          ...
          <div class="box-body" style="padding: 20px">
            ...
            <form id="formPenjualan" action="penjualan_act.php?preorder" method="post" onSubmit="return cek(this)">
              ...
              <div class="row">
                ...
                <div class="col-lg-3">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="no_telp" name="no_telp" placeholder="Masukkan No Tel Pelanggan .. (Wajib)" required>
                  </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="pull-right d-flex">
                  <button class="btn btn-info" onclick="setActionAndSubmit('penjualan_tambah.php?to-order')"><i class="fa fa-undo"></i> Transaksi Biasa</button>
                  <button class="btn btn-success" onclick="setActionAndSubmit('penjualan_act.php?preorder')"><i class="fa fa-check"></i> Buat Transaksi</button>
                </div>
              </div>
