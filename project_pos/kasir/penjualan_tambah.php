...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <a href="penjualan_preorder.php" class="btn btn-sm btn-primary"> <i class="fa fa-plus"></i> &nbsp; Pre Order</a>
              ...
              <div class="row">
                ...
                <div class="col-lg-3">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="pelanggan" required="required" value="<?= $pelanggan?>" placeholder="Masukkan Nama Pelanggan .. (Wajib)">
                  </div>
              ...
              <div class="row">
                ...
                <div class="col-lg-9">
                  ...
                  <table class="table table-bordered table-striped table-hover" id="table-pembelian">
                    ...
                    <?php
                    $tbodypreorder = isset($_POST['table_html']) ? $_POST['table_html'] : null;
                    ?>
                    <tbody>
                      <?php 
                        echo $tbodypreorder;
                    ...
                    <div class="col-lg-6">
                      <table class="table table-bordered table-striped">
                        <tr>
                          ...
                          <td>
                            <input type="hidden" name="sub_total" class="sub_total_form" value="<?=$sub_total?>">
                            <span class="sub_total_pembelian" id="0">Rp.<?php echo $sub_total?>,-</span>
                          </td>
                        </tr>
                        <tr>
                          <th>Diskon</th>
                          <td>
                            <div class="row">
                              <div class="col-lg-10">
                                <input class="form-control total_diskon" type="number" min="0" max="100" id="0" name="diskon" value="<?php echo $diskon?>" required="required">
                              </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <input type="hidden" name="total" class="total_form" value="<?php echo $total?>">
                            <span class="total_pembelian" id="0">Rp.<?php echo $total?>,-</span>
                          </td>
                        </tr>
                      </table>
                    </div>
